export class PopUpData{
    // Delivery Services
    APSRTC:string = "We utilize APSRTC cargo services for cost-effective delivery within Andhra Pradesh and Hyderabad, Telangana. Door delivery is available subject to location availability. This option is pocket-friendly, making it a great choice for saving on delivery costs."
    ...
    Pocket_Friendly:string = "This cost-efficient option is ideal for those who prefer to pick up their mangoes directly. It is a simple, no-frills packaging designed for convenience when transporting mangoes to nearby locations. Please note, this packaging offers minimal protection and is recommended for short distances only."
    Basic:string = "The Basic Packaging option is a more economical choice for those looking to save money. While it provides adequate protection, it does not offer the same level of durability or storage benefits as the Premium Packaging. It is a practical option for those with budget considerations."
}
